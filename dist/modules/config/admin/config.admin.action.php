...
class Config_admin_action extends Action_admin
{
	...
	private function size()
	{
		...
		{
			$result = array(
				"files" => File::rglob_size('', false, true, false, '/^'.preg_quote((defined('USERFILES') && USERFILES ? USERFILES : 'userfls'), '/').'$/', false, false, -1, true),
				"user_files" => File::rglob_size((defined('USERFILES') && USERFILES ? USERFILES : 'userfls').'/', false, true, false, false, true, false, -1, true),
				"db" => DB::size(),
			);
